...
- Dapat meningkatkan konsentrasi dan fokus pemain untuk berhasil menyelesaikan labirin ini. Karena bentuk dindingnya yang abstrak dan        jalan yang berbelok-belok tentu akan membuat cukup pusing melihatnya.
- Melatih pemecahan masalah pada setiap labirin bagaimana caranya mencari jalan yang tepat dan benar agar sampai ke tujuan.
- Game ini akan melatih kesabaran pemain agar tidak mudah menyerah saat menghadapi jalan buntu, atau saat salah terus dalam memilih jalan. 
- Memberikan hiburan karena game ini pun tersedia bermacam level dengan tingkat kesulitan yang berbeda pula. Apalagi akan menarik minat      bagi orang yang menyukai permainan tantangan santai maupun yang ingin mengasah logikanya. 

CARA BERMAIN 
1) Mulailah permainan dengan menjalankan file kode game di terminal. Nanti akan ditampilkan di layar menu permainan yang tersedia. 
2) Setelah layar menu utama muncul, akan menampilkan 5 level permainan, pilih mana yang ingin dimainkan duluan. Gunakan tombol panah atas     (up-arrow) dan panah bawah (down-arrow) untuk memilih level. 
3) Jika sudah memilih, tekan enter untuk memuat labirin dan memulai permainannya.
4) Setelah labirin muncul jangan lupa perhatikan peran setiap elemen. Huruf O sebagai karakter utama yang akan dikendalikan untuk             menyusuri labirin. Huruf S sebagai tanda titik mulai (Start) dan huruf F sebagai tanda titik akhir (Finish).
5) Gunakan keyboard untuk mengontrol gerakan dengan cara kontrol panah atas untuk gerak ke atas,  panah bawah untuk bergerak ke bawah,        panah kiri untuk ke kiri, dan panah kanan untuk ke arah kanan.
6) Jika mencoba bergerak ke posisi dinding atau menabraknya, maka karakter O tidak akan bergerak.
